...
const ListingImages: React.FC<ListingImagesProps> = ({ imageSrc }) => {
        ...
        <div className='col-span-2 overflow-hidden'>
          {imageSrc[0] && (
            <div className='h-full relative overflow-hidden bg-red-200 rounded-l-lg'>
              <Image
                // onClick={() => setShowAllPhotos(true)}
                className='cursor-pointer object-cover rounded-l-lg relative'
                src={imageSrc[0]}
                alt='image'
                fill
              />
      ...
      <div className='flex flex-col items-center gap-4 w-full'>
        <div className='w-full h-[80vw] md:w-[60vw] relative md:h-[45vw]'>
          <Image
            ...
            fill
            className='object-cover cursor-pointer rounded-lg'
            onClick={() => setSelectedImage(imageSrc[0])}
          />
        </div>
